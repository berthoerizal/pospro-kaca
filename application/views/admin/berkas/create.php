...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <?php echo form_open_multipart(base_url('berkas/store')); ?>
            <div class="form-group">
                <label for="name_file">Nama File</label>
                <input type="text" class="form-control form-control-sm" name="name_file" id="name_file" placeholder="Nama File" value="<?php echo set_value('name_file'); ?>" required>
            </div>
            <div class="form-group">
                <label for="file">File</label><br>
                <input type="file" name="file" id="file" multiple onchange="GetFileSize()" required><br>
